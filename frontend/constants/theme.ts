...
export const brandPalette = {
  dark: {
    background: "#020202",
    backgroundGradient: ["#020202", "#050505", "#020202"],
     ambientBackdrop: [
      {
        type: 'radial',
        at: { x: '22%', y: '25%' },
        colors: ['rgba(12,12,12,0.9)', 'transparent 58%'],
      },
      {
        type: 'radial',
        at: { x: '78%', y: '62%' },
        colors: ['rgba(8,8,8,0.85)', 'transparent 65%'],
      },
      {
        type: 'linear',
        angle: '145deg',
        colors: ['#000000', '#090909 45%', '#141418 90%'],
      },
    ],
    surface: "#111827",
    surfaceAlt: "#0d0d0d",
    ...
    borderAccent: "rgba(0,255,200,0.2)",
    textPrimary: "#f8fafc",
    ...
    accentWarm: "#ff3366",
    glowPrimary: "rgba(0,228,255,0.28)",
    glowSecondary: "rgba(255,51,136,0.22)",
    accentGradient: ['#00ffc8', '#00e4ff'],
    glowTertiary: "rgba(0,255,200,0.18)",
    cardGradient: ["rgba(8,8,8,0.92)", "rgba(12,12,18,0.85)"],
  ...
  light: {
    ...
    ambientBackdrop: [
      {
        type: 'radial',
        at: { x: '25%', y: '25%' },
        colors: ['rgba(14,165,233,0.3)', 'transparent 55%'],
      },
      {
        type: 'radial',
        at: { x: '75%', y: '70%' },
        colors: ['rgba(249,115,22,0.25)', 'transparent 60%'],
      },
      {
        type: 'linear',
        angle: '135deg',
    ...
    glowSecondary: "rgba(249,115,22,0.25)",
    glowTertiary: "rgba(14,165,233,0.18)",
    borderAccent: "rgba(15,118,110,0.18)",
    shadowAccent: "rgba(14,165,233,0.25)",
    cardGradient: [
      "rgba(255,255,255,0.96)",
      "rgba(248,250,252,0.92)",
    ],
    shadow: "0 20px 35px rgba(14,165,233,0.25)",
  },
};
